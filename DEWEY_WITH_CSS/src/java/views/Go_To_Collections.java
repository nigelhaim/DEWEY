 ...
 * @author nigel
 */
public class Go_To_Collections extends HttpServlet {

    /**
     * A view class where it selects the books and forwards to Edit_collections.jsp
     */
    ...
    public void init(ServletConfig config) throws ServletException
    {
        ...
        try{
            ...
            Logger.getLogger(Go_To_Collections.class.getName()).log(Level.SEVERE, null, ex);
        } 
    }
